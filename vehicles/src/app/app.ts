...
export class App implements AfterViewInit{
  ...
  vehicle: Vehicle = {
    ...
    features: ['Bluetooth', 'Backup Camera', 'Heated Front Seats', 'Cruise Control', 'Touchscreen Display', 'CarPlay', 'Keyless Entry', 'Alloy Wheels', 'A/C', 'Power Windows', 'Power Locks', 'Traction Control'], 
    carImages: [
